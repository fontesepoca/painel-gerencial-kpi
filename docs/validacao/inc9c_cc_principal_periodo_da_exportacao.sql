-- ============================================================================
-- INCREMENTO 9c - o defeito confere com a exportacao da 9815?
--
...
--
-- Mesma consulta da inc9b, com o periodo da exportacao de dois meses. O que
-- vier marcado como 'linha que a 9815 PERDE' TEM que estar ausente do xlsx.
-- Se aparecer no xlsx, minha leitura da consulta esta errada.
--
-- Cenario: 01/06 a 31/07/2026, competencia, filiais 7/12/25 - o MESMO periodo
-- da exportacao de dois meses, para dar para cruzar linha a linha.
-- ============================================================================
